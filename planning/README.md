...
| [plan-00-hardening.md](plan-00-hardening.md) | Restructure + fragility fixes, no new features | 🟢 Done | — |
| [plan-01-adopters-auth-security.md](plan-01-adopters-auth-security.md) | Supabase Auth, adopter self-registration, RLS | 🔵 In progress | plan-00 |
